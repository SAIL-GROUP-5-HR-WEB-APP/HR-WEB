...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-[90px] bg-gradient-to-b from-black/80 to-transparent backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.2)] transition-all duration-500">
