// 2. departmentdata.tsx (The dummy data file)
// File Location: src/Pages/departmentsData.tsx
// Changes: No changes needed, but included for completeness.

// Define the types for your data to ensure consistency and prevent errors
interface Employee {
    id: number;
    name: string;
    title: string;
  ...
  const departmentsData: Department[] = [
    {
      ...
      employees: [
        ...
        { id: 106, name: "Frank Miller", title: "DevOps Engineer", email: "frank@example.com" },
        { id: 107, name: "Grace Davis", title: "Mobile Developer", email: "grace@example.com" },
      ],
    },
    {
      id: 2,
